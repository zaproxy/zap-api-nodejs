 ...
 * This component is optional and therefore the API will only work if it is installed
 **/
Selenium.prototype.setOptionChromeBinaryPath = function (string, callback) {
  if (typeof callback === 'function') {
    this.api.request('/selenium/action/setOptionChromeBinaryPath/', {'String': string}, callback);
    return;
  }
  return this.api.requestPromise('/selenium/action/setOptionChromeBinaryPath/', {'String': string});
};
 ...
 * This component is optional and therefore the API will only work if it is installed
 **/
Selenium.prototype.setOptionLastDirectory = function (string, callback) {
  if (typeof callback === 'function') {
    this.api.request('/selenium/action/setOptionLastDirectory/', {'String': string}, callback);
    return;
  }
  return this.api.requestPromise('/selenium/action/setOptionLastDirectory/', {'String': string});
};
